...
<template>
  ...
  <div class="star-wars-intro">
    <!-- Blue Intro Text -->
    <p class="intro-text">Samodzielne Studio Projektujące Gry
przedstawiają... </p>
    ...
    <div class="main-content">
      <div class="title-content">
        <p class="content-header">Epejsodion I<br />Powrót z Czeczeni</p>

        <br />

        <p class="content-body">
            Jacuś po dwuletnim urlopie w czeczeńskim gułagu ,powraca do swojego rodzinnego miasta, aby dowiedzieć się że jego Soplicowy domek który dostał w spadku
został skonsw..skon.skonfi....skonfiskowany przez komornika za nie płacenie podatków, a co więcej, z niewyjaśnionych przyczyn
 władze Wielkiego Trójmiasta wystawiają za Jacusiem list gończy.
Jacuś wyrusza w kolejną podróż aby odmienić swój los a na swojej drodze czeka na niego wiele przeszkód i niesamowitych bohaterów.
        </p>
